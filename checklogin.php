<?php
  ...
  if($logged == true){
    ...
    if($sessionTTL > $inactividad){
      ...
      echo '<meta http-equiv="refresh" content="1; url='.   $_SESSION['page_position'] . 'login.php">';
      die();
    }
  }else{
      ...
      echo "<p><h3>Por favor ingrese sus credenciales.</h3></p>";
      session_destroy();
      echo '<meta http-equiv="refresh" content="3; url='.   $_SESSION['page_position'] . 'login.php">';
      die();
  }
